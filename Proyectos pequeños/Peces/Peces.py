...
def Forward_VonBertanlanffy(theta, t):

    k, L_inf, t_0 = theta
    L = L_inf*(1- np.exp(-k(t-t_0)))
    return L
'''
def VonBertanlanffyODE(P,t,theta_1,theta_2):
...
####### MCMC ######
# Modelo
dinamica = VonBertanlanffyODE
modelo = 'VonBertanlanffy'
